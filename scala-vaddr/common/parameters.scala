...
// DOC include start: BOOM Parameters
  ...
  /* CMAP/SAB parameters */
  numSabPipeStages: Int = 5,  // Number of SAB pipeline stages (1=same-cycle Wire, rest=Reg)
...
trait HasBoomCoreParameters extends freechips.rocketchip.tile.HasCoreParameters
{
  ...
  val numSabPipeStages = boomParams.numSabPipeStages // SAB pipeline depth (1=same-cycle, rest=cross-cycle Regs)
